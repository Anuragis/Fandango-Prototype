            ...
            <div>
                ...
                <form onSubmit = {this.handleSubmit.bind(this)}>
                    <div className="form-group"> 
                        ...
                        <input onChange = {this.handleChange} type="text" value={this.state.movieTitle} className="form-control" id="title" name="title" placeholder="Movie Title"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="genre" className="control-label">Genre</label>
                        <input onChange = {this.handleChange} type="text" value={this.state.movieCategory} className="form-control" id="genre" name="genre" placeholder="Movie Genre, Comma Separated"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="trailerLink" className="control-label">Trailer Link</label>
                        <input onChange = {this.handleChange} type="text" value={this.state.trailerLink} className="form-control" id="trailerLink" name="trailerLink" placeholder="Trailer Link"/>
                    </div>
                    <div className="form-group">
                        <label className="control-label " htmlFor="description">Description</label>
                        <input onChange = {this.handleChange} value={this.state.movieDescription} className="form-control" cols="40" id="description" name="description" rows="10"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="cast" className="control-label">Cast</label>
                        <input onChange = {this.handleChange} value={this.state.cast} type="text" className="form-control" id="cast" name="cast" placeholder="Cast, Comma Separated"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="movieLength" className="control-label">Movie Length</label>
                        <input onChange = {this.handleChange} value={this.state.movieLength} type="text" className="form-control" id="movieLength" name="movieLength" placeholder="Movie Length"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="releaseDate" className="control-label">Release Date</label>
                        <input onChange = {this.handleChange} value={this.state.releaseDate} type="text" className="form-control" id="releaseDate" name="releaseDate" placeholder="Release Date"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="moviePhoto" className="control-label">Movie Photo</label>
                        <input onChange = {this.handleChange} value={this.state.moviePhoto} type="text" className="form-control" id="moviePhoto" name="moviePhoto" placeholder="Movie Photo"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="movieRating" className="control-label">Movie Rating</label>
                        <input onChange = {this.handleChange} value={this.state.movieRating} type="text" className="form-control" id="movieRating" name="movieRating" placeholder="Movie Rating"/>
                    </div>
                    <div className="form-group"> 
                        <label htmlFor="movieScreen" className="control-label">Movie Screen</label>
                        <input onChange = {this.handleChange} value={this.state.screen} type="text" className="form-control" id="movieScreen" name="movieScreen" placeholder="Movie Screen, Comma Separated"/>
                    </div>
                    <div className="form-group">
