            ...
            <div>
                ...
                <form onSubmit = {this.handleSubmit.bind(this)}>
                    <div class="form-group"> 
                        ...
                        <input onChange = {this.handleChange} type="text" class="form-control" id="title" name="title" placeholder="Movie Title"/>
                    </div>
                    <div class="form-group"> 
                        <label for="genre" class="control-label">Genre</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="genre" name="genre" placeholder="Movie Genre, Comma Separated"/>
                    </div>
                    <div class="form-group"> 
                        <label for="trailerLink" class="control-label">Trailer Link</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="trailerLink" name="trailerLink" placeholder="Trailer Link"/>
                    </div>
                    <div class="form-group">
                        <label class="control-label " for="description">Description</label>
                        <input onChange = {this.handleChange} class="form-control" cols="40" id="description" name="description" rows="10"/>
                    </div>
                    <div class="form-group"> 
                        <label for="cast" class="control-label">Cast</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="cast" name="cast" placeholder="Cast, Comma Separated"/>
                    </div>
                    <div class="form-group"> 
                        <label for="movieLength" class="control-label">Movie Length</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="movieLength" name="movieLength" placeholder="Movie Length"/>
                    </div>
                    <div class="form-group"> 
                        <label for="releaseDate" class="control-label">Release Date</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="releaseDate" name="releaseDate" placeholder="Release Date"/>
                    </div>
                    <div class="form-group"> 
                        <label for="moviePhoto" class="control-label">Movie Photo</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="moviePhoto" name="moviePhoto" placeholder="Movie Photo"/>
                    </div>
                    <div class="form-group"> 
                        <label for="movieRating" class="control-label">Movie Rating</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="movieRating" name="movieRating" placeholder="Movie Rating"/>
                    </div>
                    <div class="form-group"> 
                        <label for="movieScreen" class="control-label">Movie Screen</label>
                        <input onChange = {this.handleChange} type="text" class="form-control" id="movieScreen" name="movieScreen" placeholder="Movie Screen, Comma Separated"/>
                    </div>
                    <div class="form-group">
